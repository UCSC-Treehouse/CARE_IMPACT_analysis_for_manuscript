...
rsem_kitchen_files <- tibble(file_name = list.files(
  path = rsem_path,
...
TH34_2292_S01_expr <- rsem_kitchen_files %>%
  filter(str_detect(file_name, "TH34_2292_S01")) %>%
  unnest(rsem_raw) %>%
...
quantile(TH34_2292_S01_expr$log2TPM1, 0.95)
