...
non_outliers_to_plot <- tribble(
  ~gene, ~Sample_ID,
  "MEK", "TH34_1350_S01"
) %>%
  mutate(outlier_relative_to = "non_outlier promoted by curation")
...
pmap(list(non_outliers_to_plot$gene, non_outliers_to_plot$Sample_ID, non_outliers_to_plot$outlier_relative_to), plot_distributions)
