...
update_cohort_strings <- function(x) {
  str_replace(x,
    ...
    str_replace("same_inferred_diagnosis", "diseases of top 6 most correlated samples") %>%
...
# create distribution figure for manuscript
```{r}
...
t5 <- pmap(list(other_genes_of_interest$gene, 
