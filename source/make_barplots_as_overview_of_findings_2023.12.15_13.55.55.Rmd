...
```{r}
light_disease_group_vector <- disease_group_vector 
light_disease_group_vector[1:4] <- c('#DDCC77', '#117733', '#88CCEE', '#AA4499') # '#332288', '#DDCC77', '#117733', '#88CCEE', '#882255', '#44AA99', '#999933', '#AA4499'.
p +
  scale_fill_manual("Diagnosis group",
                    values = light_disease_group_vector) 

```
https://cran.r-project.org/web/packages/khroma/vignettes/tol.html
```{r}

pale <- c(`pale blue` = "#BBCCEE", `pale cyan` = "#CCEEFF", 
`pale green` = "#CCDDAA", `pale yellow` = "#EEEEBB", `pale red` = "#FFCCCC", 
`pale grey` = "#DDDDDD")

pale_disease_group_vector <- disease_group_vector 
pale_disease_group_vector[1:4] <- pale[c(2, 3, 4, 5)] # '#332288', '#DDCC77', '#117733', '#88CCEE', '#882255', '#44AA99', '#999933', '#AA4499'.
p +
  scale_fill_manual("Diagnosis group",
                    values = pale_disease_group_vector) 

```
comnbo pale and light
```{r}
light_disease_group_vector <- disease_group_vector 
light_disease_group_vector[1:4] <- c('#DDCC77', '#117733', '#88CCEE', '#AA4499') # '#332288', '#DDCC77', '#117733', '#88CCEE', '#882255', '#44AA99', '#999933', '#AA4499'.
...
pale_light_disease_group_vector <- disease_group_vector 
pale_light_disease_group_vector[1:4] <- c('#DDCC77', '#88CCEE',"#CCDDAA", "#FFCCCC")
p +
  scale_fill_manual("Diagnosis group",
                    values = pale_light_disease_group_vector) 

```

# colors from river plot
```{r}
...
blue_beige_disease_group_vector <- disease_group_vector 
 blue_beige_disease_group_vector[1:4] <- c('#A8CFE4', '#468FC3',"#F3E0C4", "#ab8578")
blue_beige_disease_group_vector[1:4] <- c('#A8CFE4', '#468FC3',"#F3E0C4", "#c99e8f")
p +
  scale_fill_manual("Diagnosis group",
                    values = blue_beige_disease_group_vector) 


```


blue_beige_modified_disease_group_vector
```{r}

blue_beige_modified_disease_group_vector <- disease_group_vector 
 blue_beige_modified_disease_group_vector[1:4] <- c('#A8CFE4', '#468FC3',"#F3E0C4", "#CCDDAA")
p +
  scale_fill_manual("Diagnosis group",
                    values = blue_beige_modified_disease_group_vector) 
```
