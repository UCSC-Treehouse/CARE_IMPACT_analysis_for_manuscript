...
2023.12.21_12.38.35 - remove accepted so I can make things narrow again

conclusions for 2023.12.21_12.38.35 - i ended up having to make it 9: wide anyway, so 10" isn't much different

2024.01.17_14.20.19 - add table so I can edit the file
...
node_labels <- all_nodes  %>%
  ...
  summarize(n = n(),
            pct = round(100*n/nrow(tx_treatments_raw), 1))
