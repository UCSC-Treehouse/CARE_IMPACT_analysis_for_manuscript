...
version 2023.12.20_10.18.16 adding facets and new labels
...
finding_categories_for_plot <- finding_categories %>%
  ...
  mutate(simplified_molecular_category = 
           factor(molecular_category_name,
  ...
  mutate(Prioritization = str_replace(Prioritization, "Deferred", "Accepted and deferred") %>%
           str_replace("Prioritized", "Accepted and prioritized") %>%
           factor(levels = c("Accepted and prioritized",
                             "Accepted and deferred",
                             "Declined")))
#finding_categories_for_plot$prioritization                                       
